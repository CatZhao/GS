        ...
        <td width="331" align="right" valign="top">
            <table width="350" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td align="left" valign="middle" ><a href="${ctx }/login_logout.action">退出</a></td>
                </tr>
            </table>
        </td>
    </tr>
            ...
            <table width="98%" border="0" align="center">
                <tr>
                    <td width="76" height="100" align="center" valign="middle">
                        <div class="left-tx">
                            <s:if test="%{#session.SYS_USER.image != null && #session.SYS_USER.image !=''}">
                            	<img src="${ctx}/upload/<s:property value='#session.SYS_USER.image'/>" width="70" height="70" />
                            </s:if><s:else>
